...
from earthgazer.cli.services import create_location
from earthgazer.cli.services import delete_location
from earthgazer.cli.services import get_location_by_id
from earthgazer.cli.services import get_locations
from earthgazer.cli.services import update_location
...
def list(output_json):
    ...
    if output_json:
        ...
        for loc in locs:
            ...
            table.add_row(str(loc["id"]), loc["name"], f"{lon}, {lat}", active_str)
...
"""
        ...
        panel = Panel(details, title="Location Details", border_style="blue")
        console.print(panel)
...
def create(name, min_lon, min_lat, max_lon, max_lat, from_date, to_date, active, output_json):
    ...
    if output_json:
        ...
        console.print("[green]Location created successfully[/green]")
